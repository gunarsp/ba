 ...
 * invoice_item_taxable		Sum of ba_invoice_item_amounts.item_total where is_taxable = 1
...
function invoice_tax_rate_name($invoice_tax_rate) {
    ...
    /* Invoice tax rate */
    return $invoice_tax_rate->tax_rate_name . ' @ ' . format_number($invoice_tax_rate->tax_rate_percent, TRUE, $CI->mdl_ba_data->setting('decimal_taxes_num')) . '%';
