				...
				<tr>
					...
					<td>
						<?php if($module->module_version < $module->module_available_version) {
							echo anchor('ba_modules/upgrade/' . $module->module_path, $module->module_version . ' - ' . $this->lang->line('upgrade') . ' (' . $module->module_available_version .')', array('style'=>'color: red; font-weight: bold;'));
						}
						else {
					...
					<td class="last"><?php if($module->module_enabled) {echo anchor('ba_modules/uninstall/' . $module->module_path, $this->lang->line('uninstall'));}else {echo anchor('ba_modules/install/' . $module->module_path, $this->lang->line('install'));} ?></td>
				</tr>
