...
class Mdl_ba_Modules extends MY_Model {
    ...
    public function __construct() {
        ...
        /* Define table name */
        $this->table_name = 'ba_modules';

        /* Define primary key */
        $this->primary_key = 'ba_modules.module_id';

        /* Define default order by */
        $this->order_by = 'ba_modules.module_order, ba_modules.module_path';
    ...
    public function load_custom_languages() {
        ...
        foreach ($this->custom_modules as $module) {
            ...
            if ($module->module_enabled) {
                ...
                if (file_exists(APPPATH . '/modules_custom/' . $module->module_path . '/language/' . $this->mdl_ba_data->setting('default_language') . '/' . $module->module_path . '_lang.php')) {

                    $lang = $this->mdl_ba_data->setting('default_language');
