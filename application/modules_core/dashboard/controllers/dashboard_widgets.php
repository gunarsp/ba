...
class Dashboard_Widgets extends Admin_Controller {
    ...
    function total_paid() {
        ...
        if ($this->mdl_ba_data->setting('dashboard_total_paid_cutoff_date')) {

            $params['where']['ba_payments.payment_date >='] = $this->mdl_ba_data->setting('dashboard_total_paid_cutoff_date');
