...
class Mdl_Invoice_Groups extends MY_Model {
	...
	public function __construct() {
		...
		$this->table_name = 'ba_invoice_groups';

		$this->primary_key = 'ba_invoice_groups.invoice_group_id';

		$this->select_fields = "
		SQL_CALC_FOUND_ROWS ba_invoice_groups.*";

		$this->order_by = 'ba_invoice_groups.invoice_group_prefix';
	...
	public function adjust_invoice_number($invoice_id, $invoice_group_id) {
		...
		if ($invoice->invoice_group_id <> $invoice_group_id) {
			...
			$this->db->update('ba_invoice_groups');
