			...
			<div class="content toggle">
				...
				<form method="post" action="<?php echo site_url($this->uri->uri_string()); ?>">
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_address')) { echo $this->mdl_client_account->form_value('client_address'); } else { ?>
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_address_2')) { echo $this->mdl_client_account->form_value('client_address_2'); } else { ?>
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_city')) { echo $this->mdl_client_account->form_value('client_city'); } else { ?>
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_state')) { echo $this->mdl_client_account->form_value('client_state'); } else { ?>
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_zip')) { echo $this->mdl_client_account->form_value('client_zip'); } else { ?>
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_country')) { echo $this->mdl_client_account->form_value('client_country'); } else { ?>
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_phone_number')) { echo $this->mdl_client_account->form_value('client_phone_number'); } else { ?>
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_fax_number')) { echo $this->mdl_client_account->form_value('client_fax_number'); } else { ?>
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_mobile_number')) { echo $this->mdl_client_account->form_value('client_mobile_number'); } else { ?>
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_email_address')) { echo $this->mdl_client_account->form_value('client_email_address'); } else { ?>
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_web_address')) { echo $this->mdl_client_account->form_value('client_web_address'); } else { ?>
					...
					<dl>
						...
						<dd><?php if (!$this->mdl_ba_data->setting('cc_enable_client_tax_id')) { echo $this->mdl_client_account->form_value('client_tax_id'); } else { ?>
					...
					<?php if ($this->mdl_ba_data->setting('cc_edit_enabled')) { ?>
