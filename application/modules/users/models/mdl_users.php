...
class Mdl_Users extends MY_Model {
	...
	public function save_change_password($user_id) {
		...
		if ($user_id) {
			...
			$this->db->update('ba_users', $db_array);
	...
	public function get_email_address($user_id) {
		...
		return $this->db->get('ba_users')->row()->email_address;
