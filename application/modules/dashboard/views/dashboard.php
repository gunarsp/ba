...
<div class="grid_7" id="content_wrapper">
	...
	<?php if ($this->mdl_ba_data->setting('dashboard_show_overdue_invoices') == "TRUE" and $overdue_invoices) { ?>
	...
	<?php if ($this->mdl_ba_data->setting('dashboard_show_quotes') == "TRUE") { ?>
	...
	<?php if ($this->mdl_ba_data->setting('dashboard_show_open_invoices') == "TRUE") { ?>
	...
	<?php if ($this->mdl_ba_data->setting('dashboard_show_pending_invoices') == "TRUE") { ?>
	...
	<?php if ($this->mdl_ba_data->setting('dashboard_show_closed_invoices') == "TRUE") { ?>
