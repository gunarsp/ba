...
class Mdl_Email_Templates extends MY_Model {
	...
	public function __construct() {
		...
		$this->table_name = 'ba_email_templates';

		$this->primary_key = 'ba_email_templates.email_template_id';

		$this->select_fields = "
		SQL_CALC_FOUND_ROWS ba_email_templates.*";
	...
	public function get_list() {
		...
		return $this->db->get('ba_email_templates')->result();
