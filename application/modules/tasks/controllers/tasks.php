...
class Tasks extends Admin_Controller {
	...
	function __construct() {
		...
		if (!$this->mdl_ba_modules->check_enable('tasks')) {
	...
	function create_invoice() {
		...
		if (!$this->mdl_invoices->validate_create()) {
			...
			if ($task_id) {
				...
				$task = $this->mdl_tasks->get(array('where'=>array('ba_tasks.task_id'=>$task_id)));
	...
	function save_settings() {
		...
		if ($this->input->post('dashboard_show_open_tasks')) {
			...
			$this->mdl_ba_data->save('dashboard_show_open_tasks', "TRUE");

		}

		else {

			$this->mdl_ba_data->save('dashboard_show_open_tasks', "FALSE");
	...
	function dashboard_widget() {
		...
		if ($this->mdl_ba_data->setting('dashboard_show_open_tasks') == "TRUE") {
