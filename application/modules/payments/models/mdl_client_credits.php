...
class Mdl_Client_Credits extends MY_Model {
	...
	public function __construct() {
		...
		$this->table_name = 'ba_client_credits';

		$this->primary_key = 'ba_client_credits.client_credit_id';

		$this->select_fields = "
		SQL_CALC_FOUND_ROWS *";

		$this->order_by = 'ba_client_credits.client_credit_date DESC';

		$this->joins = array(
			'ba_clients'	=>	'ba_clients.client_id = ba_client_credits.client_credit_client_id'
		);
