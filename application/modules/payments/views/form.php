			...
			<dl>
				...
				<dd>
					<select name="payment_method_id">
						...
						<option value="<?php echo $payment_method->payment_method_id; ?>" <?php if ((!uri_assoc('payment_id') and $this->mdl_ba_data->setting('default_payment_method') == $payment_method->payment_method_id) OR ($this->mdl_payments->form_value('payment_method_id') == $payment_method->payment_method_id)) { ?>selected="selected"<?php } ?>><?php echo $payment_method->payment_method; ?></option>
						<?php } ?>
					</select>
				</dd>
			</dl>
