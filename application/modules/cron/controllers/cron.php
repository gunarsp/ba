...
class Cron extends Cron_Controller {
    ...
    function email_overdue($cron_key) {
        ...
        foreach ($invoices as $invoice) {
            ...
            $email_cc = $this->mdl_ba_data->setting('default_cc');
            $email_bcc = $this->mdl_ba_data->setting('default_bcc');
            $invoice_as_body = $this->mdl_ba_data->setting('default_email_body');
    ...
    function _check_auth($cron_key) {
        ...
        if ($cron_key <> $this->mdl_ba_data->get('cron_key')) {
