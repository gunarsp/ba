<div class="left_box">
	...
	<dl>
		<dt><label><?php echo $this->lang->line('document_type'); ?>: </label></dt>
		<dd>
			<select name="document_type_id">
				<?php foreach ($document_types as $document_type) { ?>
				<option value="<?php echo $document_type->id; ?>" <?php if($document_type->id == $invoice->document_type_id) { ?>selected="selected"<?php } ?>><?php echo $document_type->name; ?></option>
				<?php } ?>
			</select>
		</dd>
	</dl>
	...
	<dl>
		<dt><label><?php echo $this->lang->line('incoming').'/'.$this->lang->line('outgoing'); ?>: </label></dt>
		<dd>
			<select name="document_incoming">
				<?php foreach ($document_incoming as $key => $title) { ?>
				<option value="<?php echo $key; ?>" <?php if($key == $invoice->document_incoming) { ?>selected="selected"<?php } ?>><?php echo $title; ?></option>
				<?php } ?>
			</select>
		</dd>
	</dl>
