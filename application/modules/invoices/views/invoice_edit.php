		...
		<div class="content toggle">
				...
				<div id="tabs">
					<ul>
						...
						<li><a href="#tab_attachment"><?php echo $this->lang->line('attachment'); ?></a></li>
						<?php if (!$this->mdl_ba_data->setting('disable_invoice_audit_history')) { ?>
					...
					<div id="tab_attachment">
						<?php $this->load->view('tab_attachment'); ?>
					</div>
