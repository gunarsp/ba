        ...
        <div class="section_wrapper">
            ...
            <div class="content toggle">
                ...
                <dl>
                    ...
                    <dd><input type="text" name="email_cc" value="<?php echo ($this->mdl_mailer->form_value('email_cc')) ? $this->mdl_mailer->form_value('email_cc') : $this->mdl_ba_data->setting('default_cc'); ?>" /></dd>
                </dl>
                <dl>
                    <dt><label><?php echo $this->lang->line('bcc'); ?>: </label></dt>
                    <dd><input type="text" name="email_bcc" value="<?php echo ($this->mdl_mailer->form_value('email_bcc')) ? $this->mdl_mailer->form_value('email_bcc') : $this->mdl_ba_data->setting('default_bcc'); ?>" /></dd>
                </dl>
                <dl>
                ...
                <dl>
                    ...
                    <dd><input type="checkbox" name="invoice_as_body" value="1" <?php if ($this->mdl_ba_data->setting('default_email_body')) { ?>checked="checked"<?php } ?>/></dd>
                </dl>
                <dl>
