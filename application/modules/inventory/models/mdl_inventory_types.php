...
class Mdl_Inventory_Types extends MY_Model {
	...
	public function __construct() {
		...
		$this->table_name = 'ba_inventory_types';

		$this->primary_key = 'ba_inventory_types.inventory_type_id';

		$this->select_fields = 'SQL_CALC_FOUND_ROWS ba_inventory_types.*';
	...
	public function is_unique($inventory_type) {
		...
		$num = $this->db->get('ba_inventory_types')->num_rows();
