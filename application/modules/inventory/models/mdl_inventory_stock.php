...
class Mdl_Inventory_Stock extends MY_Model {
    ...
    public function __construct() {
        ...
        $this->table_name = 'ba_inventory_stock';

        $this->primary_key = 'ba_inventory_stock.inventory_stock_id';

        $this->select_fields = 'SQL_CALC_FOUND_ROWS *';

        $this->joins = array(
            'ba_inventory' =>  'ba_inventory.inventory_id = ba_inventory_stock.inventory_id',
    ...
    public function adjust($inventory_id, $quantity, $invoice_item_id = 0, $inventory_stock_notes = '') {
        ...
        if ($this->track_stock($inventory_id)) {
            ...
            if ($invoice_item_id > 0) {
                ...
                $this->db->delete('ba_inventory_stock');
            ...
            $this->db->insert('ba_inventory_stock', $db_array);
    ...
    public function track_stock($inventory_id) {
        ...
        return $this->db->get('ba_inventory')->num_rows();
