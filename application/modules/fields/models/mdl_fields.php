...
class Mdl_Fields extends MY_Model {
	...
	public function __construct() {
		...
		$this->table_name = 'ba_fields';

		$this->primary_key = 'ba_fields.field_id';
	...
	public function delete($field_id) {
		...
		$field = $this->db->get('ba_fields')->row();
	...
	function get_next_field_index($object_id) {
		...
		return $this->db->get('ba_fields')->row()->max_field_index;
