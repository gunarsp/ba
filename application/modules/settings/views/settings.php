				...
				<div id="tabs">
					...
					<div id="tab_application">
						<dl>
							...
							<dd><?php echo $this->mdl_ba_data->setting('version'); ?></dd>
						</dl>
						<dl>
                        ...
                        <dl>
                            ...
                            <dd><input type="checkbox" name="enable_profiler" value="1" <?php if ($this->mdl_ba_data->setting('enable_profiler')) { ?>checked="checked"<?php } ?> /></dd>
                        </dl>
                        <dl>
