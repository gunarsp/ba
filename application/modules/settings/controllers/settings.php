...
class Settings extends Admin_Controller {
	...
	function index() {
		...
		$core_modules = $this->mdl_ba_modules->core_modules;

		$custom_modules = $this->mdl_ba_modules->custom_modules;
	...
	function _core_save() {
		...
		foreach ($this->mdl_ba_modules->core_modules as $module) {
